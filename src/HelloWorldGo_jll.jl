...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import HelloWorldGo_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("8c9296c2-eef7-5c5a-b7f9-196cb7be2712"))
platforms = [Pkg.Artifacts.unpack_platform(e, "HelloWorldGo", artifacts_toml) for e in artifacts["HelloWorldGo"]]
...
if best_platform === nothing
    @debug("Unable to load HelloWorldGo; unsupported platform $(triplet(platform_key_abi()))")
else
